    ...
    <div class="viewdetail">
      <div class="viewdetail_top">
	    ...
	    <div class="viewImageshow">
	      <img src="${view.viewImageUrl}">
	    </div>
	    <!-- 景点名称地址门票显示 -->
	    <div class="viewpartdetail">
	      <div class="viewName"><h2 style="line-height:50px;">${view.viewName}</h2></div>
	      <div class="viewTicket"><p><strong style="color:gray">门票：</strong><span style="color:red">${view.viewTicketNum}</span></p></div>
	      <div class="viewAdd"><p><strong style="color:gray">景点地址：</strong>${view.viewAddress}</p></div>
     ...
     <div class="viewIntroduce">
       <br/>
       <p style="text-indent:2em;"><span style="color:gray">详情介绍：</span>${view.viewIntroduce}</p><br/>
     </div>
    </div>
